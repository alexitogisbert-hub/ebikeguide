...
const BIKES_RAW: BikeRaw[] = [
  ...
  },
  {
    ...
    analisis:
      "De las dos montaña del catálogo es la de entrada de precio (1.189 €) y la que declara celdas de batería de una marca reconocida (Samsung). Con 26 kg (sin batería) y solo suspensión delantera, no compite con la doble suspensión de la Antgooat Speedy 29, pero tampoco su precio lo pretende.",
    pros: [
      "Celdas de batería Samsung declaradas por el fabricante",
      "522 Wh y autonomía estimada de 120 km",
      "El precio de entrada más bajo de las dos montaña",
    ],
    contras: [
...
export const EBG_DATA = {
  ...
  mejores: [
    ...
    },
    {
      ...
      resumen: "De la doble suspensión al precio de entrada más bajo: las dos eMTB de nuestro catálogo, comparadas por especificaciones.",
      intro:
        "Comparamos las dos eMTB de nuestro catálogo por lo que realmente publica cada fabricante — batería, suspensión, frenos y precio — sin forzar una única ganadora para todos los usos.",
      criterios: [
      ...
      ganadores: [
        ...
        { bikeId: "b07", motivo: "El precio de entrada más bajo del dúo montaña, con celdas de batería Samsung declaradas." },
      ],
      faq: [
        {
