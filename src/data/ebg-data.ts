  ...
  guias: [
    {
      ...
      cuerpo: [
        ...
        "Un motor central mide el par que aplicas al pedal y lo multiplica, por lo que la asistencia se siente natural y escala con el esfuerzo. Es el estándar en bicis de gama media-alta —trekking, montaña, muchas urbanas premium— y es lo que llevan la Accolmile Cola Bear o la ONESPORT OT07 de este catálogo.",
        ...
        "El par (Nm) importa más que la potencia nominal, que en la UE está limitada a 250 W en la mayoría de casos. Un motor de 80 Nm como el de la Antgooat Speedy 29 o la Accolmile Cola Bear tira bien en rampa; uno de 30-40 Nm en una bici ligera es suficiente porque hay menos peso que mover.",
