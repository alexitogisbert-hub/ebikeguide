...
const BIKES_RAW: BikeRaw[] = [
  ...
  },
  {
    ...
    analisis:
      "Es la urbana del catálogo con más autonomía anunciada (hasta 120 km). Motor de buje trasero de 42 Nm con Shimano de 7 velocidades, frenos hidráulicos y horquilla delantera con suspensión. Pesa 24 kg, en línea con las demás urbanas. Carga máxima de 120 kg.",
    pros: [
  ...
  },
  {
    ...
    autonomiaMin: 70,
    autonomiaMax: 90,
    motor: "Central Bafang M200 250 W, 65 Nm",
    motorTipo: "central",
    parNm: 65,
    velocidad: 25,
    pesoKg: 24,
    cambios: "Shimano Altus 7v",
    ...
    porQue: "El precio más bajo investigado del catálogo (desde 729 €) con motor central Bafang M200 de 65 Nm de par.",
    analisis:
      "Es la bici más barata investigada del catálogo (729-976 € según la oferta) y monta un motor central Bafang M200 de 65 Nm de par, el más alto de las tres urbanas. Cambio Shimano Altus de 7 velocidades, frenos hidráulicos de 160 mm y horquilla delantera con suspensión. Carga máxima de 120 kg. Ojo: las fuentes consultadas no coinciden en la capacidad de la batería (374 Wh calculados a partir de los amperios-hora declarados, 250 Wh según otra fuente).",
    pros: [
      "El precio más bajo investigado del catálogo",
      "Motor central Bafang M200 de 65 Nm, el mayor par de las urbanas",
      "Frenos hidráulicos, Shimano Altus 7v y peso confirmado (24 kg)",
    ],
    contras: [
  ...
  },
  {
    ...
    suspension: "Horquilla delantera con bloqueo",
    tallas: ["Única"],
    cargaMaxima: 120,
    dimensiones: null,
    nivelEquipamiento: "medio",
  ...
  },
  {
    ...
    suspension: "Horquilla delantera Suntour NEX E25 75 mm",
    tallas: ["45 cm", "50 cm", "55 cm"],
    cargaMaxima: 150,
    dimensiones: null,
    nivelEquipamiento: "completo",
    plegable: false,
    ...
    contras: [
      ...
      "30 kg de peso, la más pesada de las dos trekking",
    ],
    ofertas: [
      {
        merchantId: "amazon",
  ...
  },
  {
    ...
    analisis:
      "Cargo compacta de dos ruedas con neumáticos fatbike de 20×3.0\" y doble suspensión que priorizan estabilidad sobre velocidad. Shimano de 7 velocidades, frenos de disco hidráulicos y carga máxima de 200 kg. Pesa 38 kg — pesada, pero coherente con su propósito de carga.",
    pros: [
  ...
  guias: [
    {
      ...
      cuerpo: [
        ...
        "El par (Nm) importa más que la potencia nominal, que en la UE está limitada a 250 W en la mayoría de casos. Un motor central de 80 Nm como el de la Moma Bikes EMTB-29 PRO o la Fischer Viator tira bien en rampa; uno de 30-40 Nm en una bici ligera es suficiente porque hay menos peso que mover.",
    ...
    },
    {
      ...
      cuerpo: [
        ...
        "Una batería extraíble, como la del Moma Bikes eBike-28\", la ENGWE P275 SE o la NCM Hamburg, facilita este cuidado porque puedes guardarla en casa en vez de dejar la bici entera a la intemperie con la batería puesta.",
      ],
      productos: ["b01", "b02", "b11"],
