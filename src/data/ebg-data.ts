...
const BIKES_RAW: BikeRaw[] = [
  ...
  },
  {
    ...
    suspension: "Horquilla delantera 50 mm",
    tallas: ["Única"],
    cargaMaxima: 200,
    dimensiones: null,
    nivelEquipamiento: "completo",
  ...
  },
  {
    ...
    analisis:
      "A diferencia de la ENGWE LE20, es una cargo clásica de dos ruedas (no longtail), con neumáticos fatbike de 20x3.0\" y doble suspensión que priorizan estabilidad sobre alcance de carga máximo. Shimano de 7 velocidades, frenos de disco hidráulicos y carga máxima de 200 kg. Pesa 38 kg.",
    pros: [
